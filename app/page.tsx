...
// ToolsPage inlined to avoid stale cache issues
        ...
        <main className="p-6">
          ...
          {tab === "tools" && (
            <div className="space-y-3">
              ...
              {[
                { emoji:"📚", title:"学习平台", color:"blue", tools:[
                ...
                { emoji:"🌐", title:"翻译工具", color:"green", tools:[
                ...
                { emoji:"📊", title:"数据分析", color:"purple", tools:[
                ...
                { emoji:"🎨", title:"图片工具", color:"orange", tools:[
                ...
                { emoji:"⚙️", title:"ERP工具", color:"red", tools:[
                ...
                { emoji:"🚢", title:"物流海关", color:"indigo", tools:[
                  ...
                  <div className="p-3 grid grid-cols-2 gap-2">
                    {cat.tools.map(tool => (
                      <a key={tool.name} href={tool.url} target="_blank" rel="noopener noreferrer"
                        ...
                        <svg className="w-3 h-3 text-gray-300 flex-shrink-0 mt-0.5 ml-1 group-hover:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                      </a>
                    ))}
                  </div>
                </div>
